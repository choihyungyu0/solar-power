...
export const fallbackPolicyPrograms: PolicyProgram[] = [
  {
    id: 'fallback-knrec-apartment',
    title: '한국에너지공단 공동주택 보급사업 후보',
    region: '전국',
    target: '아파트 1개 동, 공동주택 공용부 전기 절감 검토 단지',
    supportType: '저탄소 모듈 설치 보조',
    amountText: '1개 동 최대 30kW, kW당 466,000원 추정',
    sourceName: '한국에너지공단',
    sourceUrl: null,
    status: '확인 필요',
    lastCheckedAt: null,
  ...
  {
    id: 'fallback-detached-resident',
    title: '개인 단독 설치 시 단독주택 지원 검토',
    region: '전국',
    target: '아파트 거주 개인이 단독 설치를 희망하는 경우',
    supportType: '단독주택 기준 지원 가능성 검토',
    amountText: '단독주택 3kW 기준 공고 확인 필요',
    sourceName: '경기도/시군 및 한국에너지공단 공고',
    sourceUrl: null,
    status: '확인 필요',
    lastCheckedAt: null,
